...
/**
 * This component allows to edit a  Lancamento
 */
@Component({
...
export class LancamentoEditComponent implements OnInit {
    item: any = {};
    itemDoc: AngularFirestoreDocument<Lancamento>;
    isNew: Boolean = true;
    formValid: Boolean;
    ...
    ngOnInit() {
        this.route.params.subscribe(param => {
            ...
            if (id !== 'new') {
                this.isNew = false;
                this.itemDoc = this.lancamentoService.get(id);
     ...
     * @param Lancamento item Lancamento to save
     */
    save(formValid: boolean): void {
        ...
        if (formValid) {
            if (this.isNew) {
                // Create
                this.lancamentoService.create(this.item);
                this.isNew = false;
            } else {
                // Update
                this.lancamentoService.update(this.itemDoc, this.item);
            }
            this.goBack();
        }
    }
